...
INSERT INTO users (name, lastname, email, companyname, email_confirmed, password, enabled) values (
                                                                                                      'Admin'
                                                                                                  ,'Admin'
                                                                                                  ,'testadmin1@test'
                                                                                                  ,'AdminCompany'
...
INSERT INTO users (name, lastname, email, companyname, email_confirmed, password, enabled) values ('testuser1@test', 'testuser1@test', 'testuser1@test', 'testuser1@test', true
                                                                                                  , '$2a$12$e8gTpyTsHKxoJayziSd20eZvMDCAcbBLG5Mm7HXKoXdCa/WUQzIXq', true);
